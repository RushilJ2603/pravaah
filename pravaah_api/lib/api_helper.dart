...
String parameterToString(dynamic value) {
  ...
  if (value is OccupancyClass) {
    return OccupancyClassTypeTransformer().encode(value).toString();
  }
  if (value is SourceType) {
    return SourceTypeTypeTransformer().encode(value).toString();
  }
  if (value is VehicleStopStatus) {
    return VehicleStopStatusTypeTransformer().encode(value).toString();
  }
