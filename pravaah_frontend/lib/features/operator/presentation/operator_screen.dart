...
/// `DataHealthResponse` has no computed "is everything fine" bit of its own --
/// it just reports the two backing stores.
extension _DataHealthStatus on DataHealthResponse {
  bool get isHealthy => database && redis;
}
...
class _OperatorScreenState extends ConsumerState<OperatorScreen> {
  ...
  Widget _hotspotCard(HotspotView h) {
